          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Applying logical thinking and coding skills to solve real-world challenges through projects.
                  </p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="font-semibold text-lg">Learning and Growth</h4>
                  <p className="text-muted-foreground">
                    Exploring new technologies, improving problem-solving skills, and building real-world projects
                  </p>
                </div>
              </div>
            </div>
